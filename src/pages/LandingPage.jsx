...
const LandingPage = () => {
  return (
    <div className="relative min-h-[calc(100vh-6rem)] flex items-center justify-center px-6 overflow-hidden">
      
      {/* Background Glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gold-500/10 blur-[120px] rounded-full -z-10"></div>
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-slate-400 text-lg md:text-xl font-medium mb-12 leading-relaxed max-w-2xl mx-auto italic">
          We provide quality work with care and efficiency just for you. 
          Connect with the best Ethiopian talent and global opportunities.
        </p>
