...
const Profile = () => {
  ...
  if (loading) return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center">
      <div className="text-gold-500 text-center py-20 italic font-black uppercase tracking-widest animate-pulse text-xs">
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex text-left">
      {/* 1. Sidebar ሁልጊዜ በግራ በኩል ይኖራል */}
      <Sidebar />

      {/* 2. Main Content Area */}
      <div className="flex-1 flex flex-col min-h-screen overflow-y-auto">
        <div className="max-w-6xl mx-auto px-6 py-12 w-full pt-24">
            ...
            <div className="space-y-10">
              ...
              <section className="bg-slate-900/20 border border-slate-800/50 rounded-[2rem] p-8">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  )) : <p className="text-slate-600 text-[10px] uppercase italic">No skills listed</p>}
                </div>
              </section>
            </div>
      ...
      {/* Modal Section */}
      {showAddModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/90 backdrop-blur-md p-4 text-left">
