      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 bg-slate-900 border border-gold-500/20 p-8 rounded-3xl shadow-xl">
          <h2 className="text-3xl font-bold mb-2 text-white">
            ሰላም፣ <span className="text-gold-400">{user.user_metadata?.full_name || 'ተጠቃሚ'}</span>! ✨
          </h2>
          <p className="text-slate-400">ወደ Elite Works ዳሽቦርድ እንኳን በደህና መጡ። ዛሬ ምን መስራት ይፈልጋሉ?</p>
          
          <div className="mt-8 grid grid-cols-2 gap-4">
            <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700/50">
              <p className="text-slate-500 text-sm font-medium">ያለዎት ብር</p>
              <p className="text-2xl font-bold text-gold-500 mt-1">0.00 ETB</p>
            </div>
            <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700/50">
              <p className="text-slate-500 text-sm font-medium">ያለቁ ስራዎች</p>
