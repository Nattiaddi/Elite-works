...
const Footer = () => {
  return (
    <footer className="mt-20 border-t border-white/5 bg-slate-950 relative overflow-hidden">
      ...
      {/* 1. PREMIUM BANNER: How EliteWorks Different */}
      <div className="max-w-7xl mx-auto px-6 py-24 relative">
        ...
        <div className="relative z-10 text-center">
          ...
          {/* THE CUSTOM UNDERLINE SHAPE (Beautiful Curve) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 max-w-4xl mx-auto">
            <div className="bg-white/5 p-6 rounded-[2rem] border border-white/5 hover:border-gold-500/20 transition-all">
              <Zap className="text-gold-500 mx-auto mb-4" size={24} />
            ...
            <div className="bg-white/5 p-6 rounded-[2rem] border border-white/5 hover:border-gold-500/20 transition-all">
              <ShieldCheck className="text-gold-500 mx-auto mb-4" size={24} />
            ...
            <div className="bg-white/5 p-6 rounded-[2rem] border border-white/5 hover:border-gold-500/20 transition-all">
              <Globe className="text-gold-500 mx-auto mb-4" size={24} />
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-12 border-t border-white/5">
        ...
        <div className="space-y-6">
          <Link to="/" className="text-2xl font-black text-gold-500 italic tracking-tighter block">
          ...
          <div className="flex gap-4">
            <button className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:text-gold-500 transition-colors border border-white/5">
              <Twitter size={14} />
            </button>
            <button className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:text-gold-500 transition-colors border border-white/5">
              <Linkedin size={14} />
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-3 text-[10px] font-black uppercase italic text-slate-500 tracking-widest">
            ...
            <li><Link to="/support" className="hover:text-gold-500">Open Ticket</Link></li>
            <li><Link to="/terms" className="hover:text-gold-500">Terms & Rules</Link></li>
          </ul>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            />
            <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-gold-500 text-slate-950 px-3 py-1.5 rounded-lg font-black text-[9px] uppercase italic">
              Join
            </button>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-[9px] text-slate-600 font-black uppercase tracking-[0.3em] italic">
          © 2026 ELITE WORKS CORP. BASED IN ADDIS ABABA, ETHIOPIA.
        </p>
